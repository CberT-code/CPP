...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/10/01 17:24:19 by cbertola          #+#    #+#             */
/*   Updated: 2020/10/01 17:24:21 by cbertola         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	SuperTrap	*papa1 = new SuperTrap("Herve");

	papa1->vaulthunter_dot_exe(maman2->get_name());
	maman2->takeDamage(40);
	papa1->ninjaShoebox(*prof);
	prof->takeDamage(40);
	delete papa1;
	delete maman1;
	delete bebe1;
