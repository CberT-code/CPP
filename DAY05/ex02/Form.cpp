...
void						Form::beSigned(Bureaucrat const * test){
	if (test == NULL)
		return ;
...
Form::IsNotSignedException::IsNotSignedException(const Form::IsNotSignedException &rhs)
{
  *this = rhs;
}

Form::IsNotSignedException& Form::IsNotSignedException::operator=(const Form::IsNotSignedException& rhs)
{
	(void)rhs;
 	return(*this);
}

char const        *Form::IsNotSignedException::what(void) const throw()
{
